<template>
    <div class="params-box">
        ...
        <div class="params">
            <div class="field" v-for="(ps, type) in params" key="type">
                <div class="hd">
                    <label>{{type}}</label>
                </div>
                <el-row type="flex" class="row-bg set" v-for="(param, idx) in ps" key="idx">
                    <el-col class="key">
...
export default {
    ...
    methods: {
        ...
        addParam(type, idx) {
            ...
            this.params[type].splice(idx + 1, 0, param);
        },
        deleteParam(idx) {
