...
module.exports = app => {
    class ClientController extends app.Controller {
        ...
        * show () {
            ...
            if (document) {
                this.ctx.body = renderer(this.ctx.request.query, true)(document.dsl)
            }
        }
        // post /
        * create () {
            ...
            if (document) {
                this.ctx.body = renderer(R.merge(this.ctx.request.body, this.ctx.request.params), true)(document.dsl)
            }
        }
    }
